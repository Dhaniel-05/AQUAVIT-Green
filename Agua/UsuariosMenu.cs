...
namespace Agua
{
    public partial class UsuariosMenu : Form
    {
        public UsuariosMenu()
        {
            InitializeComponent();
        ...
        {
            Globalidad.DocUsuario = (usuariosDataGridView.Rows[e.RowIndex].Cells[1].Value).ToString();
        }

        private void Buscar_TextChanged(object sender, EventArgs e)
        {
            usuariosTableAdapter.BusquedaIndexada(this.dataSet.Usuarios, this.BuscarUsuario.Text, this.BuscarUsuario.Text);
        }
