...
namespace Agua
{
    public partial class EditarPropietario : Form
    {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        try
                                        {
                                            this.propietariosTableAdapter.EditarPropietarios(this.documentoTextBox.Text, this.nombreTextBox.Text, this.direccionTextBox.Text, this.celularTextBox.Text, this.correoTextBox.Text, Convert.ToInt32(this.idPropietarioTextBox.Text));
                                            this.Close();
                                        }
                                        catch (Exception)
                                        {
        ...
        private void BtnEPSalir_Click(object sender, EventArgs e)
        {
            this.Close();
        }
    }
